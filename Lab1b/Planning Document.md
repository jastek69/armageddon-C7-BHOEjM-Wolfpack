...
Resources that were retained for future (lab_1b)use.
...
- Engine version for RDS MySQL 8.4.7
- credentials settings
    -username: admin
    - self-managed cred mgmt
...
- VPC -one you created
public access - no
security grp - rds security group
AZ - no preference

Store Database credentials in Secrets manageer
