...
resource "aws_wafv2_web_acl_logging_configuration" "lab2a_cf_waf_logging" {
  provider = aws.use1

  resource_arn = aws_wafv2_web_acl.lab2a_cf_waf01.arn

  log_destination_configs = [
    "arn:aws:s3:::aws-waf-logs-lab2a-571938892172"
  ]
}

resource "aws_wafv2_web_acl_logging_configuration" "lab2a_alb_waf_logging" {
