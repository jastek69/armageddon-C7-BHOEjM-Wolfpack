...
INSTANCE_ID="${INSTANCE_ID:-i-0fb1407782000bf49}"
SECRET_ID="${SECRET_ID:-arn:aws:secretsmanager:us-east-2:571938892172:secret:lab2a/secret12-pUIa6D}"
DB_ID="${DB_ID:-lab2a-rds01}"
...
EXPECTED_ROLE_NAME="${EXPECTED_ROLE_NAME:-lab2a-ec2-role01}"
