...
ACM_CERT_ARN="arn:aws:acm:us-east-1:571938892172:certificate/9f6a9903-2037-4cef-b406-db5b9f250a18"
WAF_WEB_ACL_ARN="arn:aws:wafv2:us-east-1:571938892172:global/webacl/lab2a-cf-waf01/97d71a48-452c-4661-b28b-92b495c2c6a5"
LOG_BUCKET="aws-waf-logs-lab2a-571938892172"

# ALB specifics (required for ALB checks)
ALB_ARN="arn:aws:elasticloadbalancing:us-east-2:571938892172:loadbalancer/app/lab2a-alb01/e431179543458306"                 # arn:aws:elasticloadbalancing:...
ALB_SG_ID="sg-0736ea0cc0f7f47ba"             # sg-...
