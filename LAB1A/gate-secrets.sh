...
INSTANCE_ID="${INSTANCE_ID:-i-014bc8c646272febd}"
SECRET_ID="${SECRET_ID:-lab1a-rds-mysql2}"
...
usage() {
  cat <<EOF
Usage:
  REGION=sa-east-1 INSTANCE_ID=i-014bc8c646272febd SECRET_ID=lab1a-rds-mysql2 ./gate_secrets_and_role.sh
...
Examples:
  ...
  REQUIRE_ROTATION=true REGION=sa-east-1 INSTANCE_ID=i-014bc8c646272febd SECRET_ID=lab1a-rds-mysql2 ./gate_secrets_and_role.sh

  # Run on the EC2 and verify it can read the secret value (does NOT print it):
  CHECK_SECRET_VALUE_READ=true REGION=sa-east-1 INSTANCE_ID=i-014bc8c646272febd SECRET_ID=lab1a-rds-mysql2 ./gate_secrets_and_role.sh
