...
usage() {
  cat <<EOF
Usage:
  REGION=sa-east-1 INSTANCE_ID=i-014bc8c646272febd DB_ID=lab-mysql ./gate_network_db.sh
...
Examples:
  REGION=sa-east-1 INSTANCE_ID=i-08f6417c154aa24df DB_ID=lab-mysql ./gate_network_db.sh

  CHECK_PRIVATE_SUBNETS=true REGION=sa-east-1 INSTANCE_ID=i-08f6417c154aa24df DB_ID=lab-mysql ./gate_network_db.sh
EOF
}
