...
INSTANCE_ID="${INSTANCE_ID:-i-068615def3e517857}"
SECRET_ID="${SECRET_ID:-arn:aws:secretsmanager:us-east-2:571938892172:secret:lab1c/secret12-fvMWAk}"
DB_ID="${DB_ID:-lab1c-rds01}"
...
EXPECTED_ROLE_NAME="${EXPECTED_ROLE_NAME:-lab1c-ec2-role01}"
